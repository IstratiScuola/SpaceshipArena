...
public class ClientSpaceship {
    ...
    public void interpolate() {
        position.x += (targetPosition.x - position.x) * LERP_FACTOR;
        position.y += (targetPosition.y - position.y) * LERP_FACTOR;
    ...
    public int getMaxHealth() { return Constants.MAX_HEALTH; }
